...
Exercise 8: rm /tmp/holberton/betty Remove file betty located in tmp/my_first_directory directory.
...
Exercise 19: 0 string SCHOOL Holberton data !:mime Holberton Create a magic file called school.mgc that can be used with the command file to detect School data files. School data files always contain "SCHOOL" at offset 0
